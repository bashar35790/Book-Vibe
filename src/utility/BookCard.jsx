...
const BookCard = ({book}) => {
  ...
  return (
    <Link to={`/bookDetails/${book.bookId}`} className="card w-full bg-white shadow-xl rounded-2xl border border-[#131313]/15 p-6 gap-6 cursor-pointer transform transition-transform hover:scale-105" >
      {/* Image Section */}
